...
$title = "Show Asides Relationships";
...
while ($row = $result->fetch_row()) {
	echo '<tr>
					<td>
						<a href="delete_has_aside.php?asideid='.$row[1].'&pageid='.$row[0].'"class="btn btn-danger">Delete</a>
						<a href="update_has_aside.php?asideid='.$row[1].'&pageid='.$row[0].'"class="btn btn-success">Update</a>
					</td>';
