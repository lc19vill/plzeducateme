...
function insert_page($values) {
	...
	$sql = "INSERT INTO a01sama_pages (pageid, title, content, parent) VALUES ('$pageid','$title','$content','$parent')";
	run_query($sql);
}
...
function insert_user($values) {
	...
	$type = $values['type'];
	$sql = "INSERT INTO a01sama_users (userid, passwd, type) VALUES ('$userid','$hashed_passwrd','$type')";
	run_query($sql);
}
